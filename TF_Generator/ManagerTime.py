...
class TimeManager:
    ...
    Methods:
        - __init__(timeframe: str, num_candles: int, logger=None): Initializes the TimeManager instance.
    ...
    def _start_time_exists(self, existing_ohlcv_df: pd.DataFrame) -> int:
        ...
        self.logger.log_debug(f"time_difference : {time_difference} {self.time_unit}")
